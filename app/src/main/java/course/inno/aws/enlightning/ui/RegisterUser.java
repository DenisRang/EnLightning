...
import course.inno.aws.enlightning.R;
...
public class RegisterUser extends AppCompatActivity {
    ...
    private void init() {
        ...
        //
        familyName = (EditText) findViewById(R.id.editTextFamilyName);
        familyName.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    TextView label = (TextView) findViewById(R.id.textViewFamilyNameLabel);
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                TextView label = (TextView) findViewById(R.id.textViewFamilyNameMessage);
                label.setText("");
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userInput != null) {
                    if (userInput.length() > 0) {
                        //todo change
                        userAttributes.addAttribute("family_name", userInput);
                    }
                }
